...
//    STRONG_WINDS("🌪", R.string.wind_strong, R.color.orange, { wind -> wind > 20 });
    ...
    WIND_CALM(0f..5.9f, "🌿", R.color.wind_calm, R.string.wind_calm_label, R.string.wind_calm_desc),
    WIND_LIGHT(6f.. 15.9f, "🍃", R.color.wind_light, R.string.wind_light_label, R.string.wind_light_desc),
    WIND_MODERATE(16f.. 30.9f, "🌬️", R.color.wind_moderate, R.string.wind_moderate_label, R.string.wind_moderate_desc),
    WIND_STRONG(31f.. 50.9f, "💨", R.color.wind_strong, R.string.wind_strong_label, R.string.wind_strong_desc),
    ...
    companion object {
        fun getRecommendation(value: Float): WindRecommendation {
            return entries.firstOrNull { it.matches(value) }
                ?: throw IllegalArgumentException("No matching recommendation for value: $value")
        }
    }
}